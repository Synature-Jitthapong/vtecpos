...
*/
public class fc_cardhistoryDao extends AbstractDao<fc_cardhistory, Integer> {

    public static final String TABLENAME = "fc_cardhistory";

    /**
     * Properties of entity fc_cardhistory.<br/>
    ...
    */
    ...
    public fc_cardhistoryDao(DaoConfig config) {
        super(config);
    }
    
    public fc_cardhistoryDao(DaoConfig config, DaoSession daoSession) {
        super(config, daoSession);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, fc_cardhistory entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public fc_cardhistory readEntity(Cursor cursor, int offset) {
        fc_cardhistory entity = new fc_cardhistory( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, fc_cardhistory entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Integer updateKeyAfterInsert(fc_cardhistory entity, long rowId) {
        return entity.getHistoryID();
    }
    
    /** @inheritdoc */
    @Override
    public Integer getKey(fc_cardhistory entity) {
        if(entity != null) {
            return entity.getHistoryID();
        } else {
            return null;
