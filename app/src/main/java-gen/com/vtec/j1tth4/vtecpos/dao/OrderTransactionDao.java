...
public class OrderTransactionDao extends AbstractDao<OrderTransaction, Integer> {
    ...
    */
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'ORDER_TRANSACTION' (" + //
                "'TRANSACTION_ID' INTEGER PRIMARY KEY NOT NULL ," + // 0: TransactionID
                "'COMPUTER_ID' INTEGER NOT NULL ," + // 1: ComputerID
                "'TRANSACTION_UUID' TEXT NOT NULL ," + // 2: TransactionUUID
                "'RESERVE_TIME' INTEGER," + // 3: ReserveTime
                "'RESERVE_STAFF_ID' INTEGER," + // 4: ReserveStaffID
                "'OPEN_TIME' INTEGER NOT NULL ," + // 5: OpenTime
                "'OPEN_STAFF_ID' INTEGER NOT NULL ," + // 6: OpenStaffID
                "'PAID_TIME' INTEGER," + // 7: PaidTime
                "'PAID_STAFF_ID' INTEGER," + // 8: PaidStaffID
                "'CLOSE_TIME' INTEGER," + // 9: CloseTime
                "'COMM_STAFF_ID' INTEGER," + // 10: CommStaffID
                "'OTHER_PERCENT_DISCOUNT' REAL," + // 11: OtherPercentDiscount
                "'OTHER_AMOUNT_DISCOUNT' REAL," + // 12: OtherAmountDiscount
                "'TRANSACTION_STATUS_ID' INTEGER NOT NULL ," + // 13: TransactionStatusID
                "'SALE_MODE' INTEGER NOT NULL ," + // 14: SaleMode
                "'TRANSACTION_NAME' TEXT," + // 15: TransactionName
                "'QUEUE_NAME' TEXT," + // 16: QueueName
                "'NO_CUSTOMER' INTEGER," + // 17: NoCustomer
                "'NO_CUSTOMER_WHEN_OPEN' INTEGER," + // 18: NoCustomerWhenOpen
                "'DOC_TYPE' INTEGER NOT NULL ," + // 19: DocType
                "'RECEIPT_YEAR' INTEGER NOT NULL ," + // 20: ReceiptYear
                "'RECEIPT_MONTH' INTEGER NOT NULL ," + // 21: ReceiptMonth
                "'RECEIPT_ID' INTEGER," + // 22: ReceiptID
                "'RECEIPT_NUMBER' TEXT," + // 23: ReceiptNumber
                "'SALE_DATE' INTEGER NOT NULL ," + // 24: SaleDate
                "'SHOP_ID' INTEGER NOT NULL ," + // 25: ShopID
                "'TRANSACTION_VAT' REAL," + // 26: TransactionVAT
                "'TRANSACTION_EXCLUDE_VAT' REAL," + // 27: TransactionExcludeVAT
                "'SERVICE_CHARGE' REAL," + // 28: ServiceCharge
                "'SERVICE_CHARGE_VAT' REAL," + // 29: ServiceChargeVAT
                "'OTHER_INCOME' REAL," + // 30: OtherIncome
                "'OTHER_INCOME_VAT' REAL," + // 31: OtherIncomeVAT
                "'TRANSACTION_VATABLE' REAL," + // 32: TransactionVATable
                "'RECEIPT_PRODUCT_RETAIL_PRICE' REAL," + // 33: ReceiptProductRetailPrice
                "'RECEIPT_SALE_PRICE' REAL," + // 34: ReceiptSalePrice
                "'RECEIPT_PAY_PRICE' REAL," + // 35: ReceiptPayPrice
                "'RECEIPT_DISCOUNT' REAL," + // 36: ReceiptDiscount
                "'RECEIPT_TOTAL_QTY' REAL," + // 37: ReceiptTotalQty
                "'VATPERCENT' REAL," + // 38: VATPercent
                "'SERVICE_CHARGE_PERCENT' REAL," + // 39: ServiceChargePercent
                "'IS_CALCULATE_SERVICE_CHARGE' INTEGER," + // 40: IsCalculateServiceCharge
                "'SESSION_ID' INTEGER NOT NULL ," + // 41: SessionID
                "'CLOSE_COMPUTER_ID' INTEGER," + // 42: CloseComputerID
                "'VOID_STAFF_ID' INTEGER," + // 43: VoidStaffID
                "'VOID_REASON' TEXT," + // 44: VoidReason
                "'VOID_TIME' INTEGER," + // 45: VoidTime
                "'MEMBER_ID' INTEGER," + // 46: MemberID
                "'HAS_ORDER' INTEGER," + // 47: HasOrder
                "'NO_PRINT_BILL_DETAIL' INTEGER," + // 48: NoPrintBillDetail
                "'BILL_DETAIL_REFERENCE_NO' INTEGER," + // 49: BillDetailReferenceNo
                "'CALL_FOR_CHECK_BILL' INTEGER," + // 50: CallForCheckBill
                "'TRANSACTION_NOTE' TEXT," + // 51: TransactionNote
                "'CURRENT_ACCESS_COMPUTER' INTEGER," + // 52: CurrentAccessComputer
                "'UPDATE_DATE' INTEGER," + // 53: UpdateDate
                "'BEGIN_TIME' INTEGER," + // 54: BeginTime
                "'END_TIME' INTEGER," + // 55: EndTime
                "'PRINT_WARNING_TIME' INTEGER," + // 56: PrintWarningTime
                "'PRINT_BEGIN_TIME' INTEGER," + // 57: PrintBeginTime
                "'ALREADY_CALCULATE_STOCK' INTEGER," + // 58: AlreadyCalculateStock
                "'ALREADY_EXPORT_TO_HQ' INTEGER," + // 59: AlreadyExportToHQ
                "'TABLE_ID' INTEGER," + // 60: TableID
                "'IS_SPLIT_TRANSACTION' INTEGER," + // 61: IsSplitTransaction
                "'IS_FROM_OTHER_TRANSACTION' INTEGER," + // 62: IsFromOtherTransaction
                "'REFERENCE_NO' TEXT," + // 63: ReferenceNo
                "'FROM_DEPOSIT_TRANSACTION_ID' INTEGER," + // 64: FromDepositTransactionID
                "'FROM_DEPOSIT_COMPUTER_ID' INTEGER," + // 65: FromDepositComputerID
                "'DELETED' INTEGER);"); // 66: Deleted
        // Add Indexes
        db.execSQL("CREATE UNIQUE INDEX " + constraint + "sale_date_idx ON ORDER_TRANSACTION" +
                " (SALE_DATE);");
        db.execSQL("CREATE UNIQUE INDEX " + constraint + "member_id_index ON ORDER_TRANSACTION" +
                " (MEMBER_ID);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'ORDER_TRANSACTION'";
        db.execSQL(sql);
    }
